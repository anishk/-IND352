				...
				switch( e.event )
				    ...
				    case 'message':
				        ...
				        if ( e.foreground )
				        {
				            ...
				            alert ("Foreground : notification received " + e);
				        ...
				        {  // otherwise we were launched because the user touched a notification in the notification tray.
				            if ( e.coldstart )
				            {
				                ...
				                alert ("Cold start notification : " + e);
				            }
				            else
				            {
				                //$("#app-status-ul").append('<li>--BACKGROUND NOTIFICATION--' + '</li>');
				                alert ("Background notification : " + e);
				            }
				        }
				       ...
				       alert ("Message count : " + e.payload.msgcnt);
